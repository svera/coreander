...
type CLIInput struct {
	...
	// IndexWorkers is the number of goroutines used to extract metadata in parallel during indexing. When nil, defaults to the number of CPUs. 0 or 1 means sequential.
