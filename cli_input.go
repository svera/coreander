...
type CLIInput struct {
	...
	// MaxSimilarityCandidates caps how many top-scoring matches a "similar document" query considers before applying MinSimilarityScoreRatio and paginating
	MaxSimilarityCandidates int `env:"MAX_SIMILARITY_CANDIDATES" default:"200" name:"max-similarity-candidates" help:"Maximum number of top-scoring matches a \"similar document\" query considers before pruning by min-similarity-score-ratio and paginating."`
	// MinSimilarityScoreRatio is the minimum fraction of the best match's score a document must reach to be considered similar enough to show in a "similar document" query
	MinSimilarityScoreRatio float64 `env:"MIN_SIMILARITY_SCORE_RATIO" default:"0.2" name:"min-similarity-score-ratio" help:"Minimum fraction of the best match's score a document must reach to be considered similar enough to show in a \"similar document\" query."`
