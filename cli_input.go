...
type CLIInput struct {
	...
	// MinPhraseOccurrenceRatio is the minimum fraction of the most frequent phrase's occurrence count that a phrase must reach to be kept as a search/related-document keyword for EPUB documents. A value of 0 disables text ranking entirely.
	MinPhraseOccurrenceRatio float64 `env:"MIN_PHRASE_OCCURRENCE_RATIO" default:"0.1" name:"min-phrase-occurrence-ratio" help:"Minimum fraction of the most frequent phrase's occurrence count that a phrase must reach to be kept as a search/related-document keyword for EPUB documents. Set to 0 to disable text ranking."`
	// MinWordOccurrenceRatio is the minimum fraction of the most frequent word's occurrence count that a word must reach to be kept as a search/related-document keyword for EPUB documents. A value of 0 disables text ranking entirely.
	MinWordOccurrenceRatio float64 `env:"MIN_WORD_OCCURRENCE_RATIO" default:"0.1" name:"min-word-occurrence-ratio" help:"Minimum fraction of the most frequent word's occurrence count that a word must reach to be kept as a search/related-document keyword for EPUB documents. Set to 0 to disable text ranking."`
