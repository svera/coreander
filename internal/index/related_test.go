	...
	return []sameSubjectsTestCase{
		{
			...
			[]index.Document{
				...
				},
				{
					...
					AuthorsSlugs:  []string{"marco-polo"},
					SeriesSlug:    "",
					SubjectsSlugs: []string{"history", "middle-age"},
				},
				{
		...
		{
			"The reference document does not have a publication date",
			"marco-polo-test-f",
			[]index.Document{
				{
					ID:   "file1.epub",
				...
				},
				{
					...
					AuthorsSlugs:  []string{"isaac-asimov"},
					SeriesSlug:    "",
					SubjectsSlugs: []string{"history", "middle-age"},
				},
				{
