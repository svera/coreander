...
|`--static-cache-ttl`                 |`STATIC_CACHE_TTL`        | Cache duration for static assets (CSS, JS, images) in seconds. Defaults to 31536000 (1 year).
|`--dynamic-image-cache-ttl`          |`DYNAMIC_IMAGE_CACHE_TTL` | Cache duration for dynamically generated images (covers, author images) in seconds. Defaults to 86400 (24 hours).
